...
const Contact: React.FC<{}> = () => {
    ...
    return (
        <section id="contact" className={`bg-gradient-to-r from-violet-600 to-violet-900 h-screen w-screen ${!scrolling && "snap-start"} relative grid place-items-center`}>
            ...
            <form onSubmit={formik.handleSubmit} className="w-4/6 h-4/6 space-y-6 flex flex-col justify-center">
                ...
                <div className="flex flex-col">
                    ...
                    <input
                        ...
                        className="invalid:border-red-700 border-2 rounded-lg bg-slate-900 text-white border-gray-900"
                    />
                </div>
